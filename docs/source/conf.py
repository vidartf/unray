...
# -*- coding: utf-8 -*-
#
# unray documentation build configuration file
#
...
project = 'unray'
copyright = '2018, Martin Sandve Alnæs'
...
_version_py = os.path.join(repo, 'unray', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'unray.tex', 'unray Documentation',
     'Martin Sandve Alnæs', 'manual'),
]
...
def setup(app):
    ...
    if not os.path.exists(doc_ext_path):
        src_file = os.path.join(here, '..', '..', 'js', 'dist', 'index.js')
