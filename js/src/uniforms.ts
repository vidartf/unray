...
function default_uniforms() {
    ...
    const user_data_groups: {[key: string]: ITypedUniformMap} = {
        ...
        isovalues: {
            ...
            u_isovalue_spacing: { value: 1.0, gltype: "float" },
            u_isovalue_spacing_inv: { value: 1.0, gltype: "float" },
            u_isovalue_scaled: { value: 0.0, gltype: "float" },
        },
        density: {
            // Function values
            t_density: { value: null, gltype: "sampler2D" },
            // Scale properties
            u_density_scale_m: { value: 1.0, gltype: "float" },
            u_density_scale_b: { value: 0.0, gltype: "float" },
            u_density_scale_k: { value: 2.0, gltype: "float" },
            // Scalar lookup table
        ...
        emission: {
            ...
            // Scale properties
            u_emission_scale_m: { value: 1.0, gltype: "float" },
            u_emission_scale_b: { value: 0.0, gltype: "float" },
            u_emission_scale_k: { value: 2.0, gltype: "float" },
            // Color lookup table
