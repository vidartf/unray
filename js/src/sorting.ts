...
// FIXME: Update function with correct type declarations.
// export
// function sort_cells(ordering: TypedArray, cells: TypedArray, coordinates: Float32Array,
//                     camera_position: number[], view_direction: number[]) {
//     /*
